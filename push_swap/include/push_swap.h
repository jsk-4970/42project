...
/*   Updated: 2025/12/23 15:16:11 by jyamada          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ftp_strlcpy(char *dest, const char *src, size_t dstsize);
int		ftp_putchar(char c);
int		ftp_putstr(char *s);
int		ftp_putnbr(long n);
int		ftp_read_next(const char *format, va_list args);
